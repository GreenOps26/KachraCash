  ...
  return (
    <div className="max-w-5xl mx-auto h-[calc(100vh-120px)] flex flex-col">
      <div className="mb-6">
        ...
        <p className="text-[#1F2937]/70">Browse active listings in your area and place bids.</p>
      </div>
      ...
      <div className="flex-1 bg-white rounded-3xl border border-black/5 shadow-sm overflow-hidden relative">
          ...
          <div className="bg-white p-4 rounded-2xl shadow-md pointer-events-auto w-72">
            ...
            <div className="space-y-2">
              <label className="flex items-center gap-2 text-sm">
                <input type="checkbox" defaultChecked className="rounded text-[#8B5CF6] focus:ring-[#8B5CF6]" />
                Plastic & Paper
              </label>
              <label className="flex items-center gap-2 text-sm">
                <input type="checkbox" defaultChecked className="rounded text-[#8B5CF6] focus:ring-[#8B5CF6]" />
        ...
        <div className="absolute top-1/3 left-1/4 transform -translate-x-1/2 -translate-y-1/2 pointer-events-auto">
          <div className="relative group cursor-pointer">
            ...
            {/* Tooltip */}
            <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 w-48 bg-white rounded-xl shadow-xl p-3 hidden group-hover:block z-10">
              <p className="font-bold text-sm text-[#1F2937]">Mixed Scrap (~5kg)</p>
              <p className="text-xs text-gray-500 mb-2">1.2 km away</p>
              <button className="w-full py-2 bg-[#8B5CF6] text-white text-xs font-bold rounded-lg hover:bg-[#7c3aed]">
                View & Bid
              </button>
            </div>
          </div>
